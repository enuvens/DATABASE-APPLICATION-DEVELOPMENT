...
INSERT INTO employees VALUES 
        ...
        , 'VPATABAL'
        , '590.423.4560'
        , TO_DATE('05-FEV-1998', 'dd-MON-yyyy')
        , 'IT_PROG'
        , 4800
        , NULL
        , 103
...
INSERT INTO employees VALUES 
        ...
        , 'JCHEN'
        , '515.124.4269'
        , TO_DATE('28-SET-1997', 'dd-MON-yyyy')
        , 'FI_ACCOUNT'
        , 8200
        , NULL
        , 108
...
INSERT INTO employees VALUES 
        ...
        , 'ISCIARRA'
        , '515.124.4369'
        , TO_DATE('30-SET-1997', 'dd-MON-yyyy')
        , 'FI_ACCOUNT'
        , 7700
        , NULL
        , 108
...
INSERT INTO employees VALUES 
        ...
        , 'LPOPP'
        , '515.124.4567'
        , TO_DATE('07-DEZ-1999', 'dd-MON-yyyy')
        , 'FI_ACCOUNT'
        , 6900
        , NULL
        , 108
...
INSERT INTO employees VALUES 
        ...
        , 'DRAPHEAL'
        , '515.127.4561'
        , TO_DATE('07-DEZ-1994', 'dd-MON-yyyy')
        , 'PU_MAN'
        , 11000
        , NULL
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'SBAIDA'
        , '515.127.4563'
        , TO_DATE('24-DEZ-1997', 'dd-MON-yyyy')
        , 'PU_CLERK'
        , 2900
        , NULL
        , 114
...
INSERT INTO employees VALUES 
        ...
        , 'SVOLLMAN'
        , '650.123.4234'
        , TO_DATE('10-OUT-1997', 'dd-MON-yyyy')
        , 'ST_MAN'
        , 6500
        , NULL
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'IMIKKILI'
        , '650.124.1224'
        , TO_DATE('28-SET-1998', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 2700
        , NULL
        , 120
...
INSERT INTO employees VALUES 
        ...
        , 'MATKINSO'
        , '650.124.6234'
        , TO_DATE('30-OUT-1997', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 2800
        , NULL
        , 121
...
INSERT INTO employees VALUES 
        ...
        , 'JAMRLOW'
        , '650.124.7234'
        , TO_DATE('16-FEV-1997', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 2500
        , NULL
        , 121
...
INSERT INTO employees VALUES 
        ...
        , 'KGEE'
        , '650.127.1734'
        , TO_DATE('12-DEZ-1999', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 2400
        , NULL
        , 122
...
INSERT INTO employees VALUES 
        ...
        , 'HPHILTAN'
        , '650.127.1634'
        , TO_DATE('06-FEV-2000', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 2200
        , NULL
        , 122
...
INSERT INTO employees VALUES 
        ...
        , 'SSTILES'
        , '650.121.2034'
        , TO_DATE('26-OUT-1997', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 3200
        , NULL
        , 123
...
INSERT INTO employees VALUES 
        ...
        , 'JSEO'
        , '650.121.2019'
        , TO_DATE('12-FEV-1998', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 2700
        , NULL
        , 123
...
INSERT INTO employees VALUES 
        ...
        , 'JRUSSEL'
        , '011.44.1344.429268'
        , TO_DATE('01-OUT-1996', 'dd-MON-yyyy')
        , 'SA_MAN'
        , 14000
        , .4
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'GCAMBRAU'
        , '011.44.1344.619268'
        , TO_DATE('15-OUT-1999', 'dd-MON-yyyy')
        , 'SA_MAN'
        , 11000
        , .3
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'NCAMBRAU'
        , '011.44.1344.987668'
        , TO_DATE('09-DEZ-1998', 'dd-MON-yyyy')
        , 'SA_REP'
        , 7500
        , .2
        , 145
...
INSERT INTO employees VALUES 
        ...
        , 'LDORAN'
        , '011.44.1345.629268'
        , TO_DATE('15-DEZ-1997', 'dd-MON-yyyy')
        , 'SA_REP'
        , 7500
        , .3
        , 146
...
INSERT INTO employees VALUES 
        ...
        , 'DLEE'
        , '011.44.1346.529268'
        , TO_DATE('23-FEV-2000', 'dd-MON-yyyy')
        , 'SA_REP'
        , 6800
        , .1
        , 147
...
INSERT INTO employees VALUES 
        ...
        , 'WSMITH'
        , '011.44.1343.629268'
        , TO_DATE('23-FEV-1999', 'dd-MON-yyyy')
        , 'SA_REP'
        , 7400
        , .15
        , 148
...
INSERT INTO employees VALUES 
        ...
        , 'JFLEAUR'
        , '650.507.9877'
        , TO_DATE('23-FEV-1998', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 3100
        , NULL
        , 120
...
INSERT INTO employees VALUES 
        ...
        , 'GGEONI'
        , '650.507.9879'
        , TO_DATE('03-FEV-2000', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 2800
        , NULL
        , 120
...
INSERT INTO employees VALUES 
        ...
        , 'ABULL'
        , '650.509.2876'
        , TO_DATE('20-FEV-1997', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 4100
        , NULL
        , 121
...
INSERT INTO employees VALUES 
        ...
        , 'SBELL'
        , '650.501.1876'
        , TO_DATE('04-FEV-1996', 'dd-MON-yyyy')
        , 'SH_CLERK'
        , 4000
        , NULL
        , 123
